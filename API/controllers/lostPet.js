module.exports = function (app) {
    ...
    app.get('/lostPet/:id?', async function (req, res) {
    ...
    app.post('/lostPet', async function (req, res) {
        const lost = await LostModel.create(req.body)
        res.json(lost)
    })

    app.put('/lostPet/:id', async function (req, res) {
    ...
    app.delete('/lostPet/:id', async function (req, res) {
        const id = parseInt(req.params.id)
        const lost = await LostModel.findByPk(id)
        await lost.destroy()
