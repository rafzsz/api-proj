...
//   app.get("/coments/:id?", auth, async function (req, res) {
...
//   app.post("/coments", auth, async function (req, res) {
//     const coment = await ComentModel.create(req.body);
//     res.json(coment);
//   });

//   app.put("/coments/:id", auth, async function (req, res) {
...
//   app.delete("/coments/:id", auth, async function (req, res) {
//     const id = parseInt(req.params.id);
//     const coment = await ComentModel.findByPk(id);
