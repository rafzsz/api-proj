module.exports = function (app) {
    ...
    app.get('/strayPet/:id?', async function (req, res) {
    ...
    app.post('/strayPet', async function (req, res) {
        const stray = await StrayModel.create(req.body)
        res.json(stray)
    })

    app.put('/strayPet/:id', async function (req, res) {
    ...
    app.delete('/strayPet/:id', async function (req, res) {
        const id = parseInt(req.params.id)
        const stray = await StrayModel.findByPk(id)
        await stray.destroy()
